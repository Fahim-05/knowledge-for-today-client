  ...
  return (
    <div className='d-flex justify-content-center mt-3'>
      {[
        ...
        >
          <Card.Header className='text-center text-warning bg-dark'>Dear Premium User<FaStar className='mb-1 ms-3'></FaStar><FaStar className='mb-1 ms-1'></FaStar><FaStar className='mb-1 ms-1'></FaStar></Card.Header>
          <Card.Body>
